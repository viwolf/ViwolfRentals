...
{
    public partial class ViewerPdf : System.Web.UI.Page
    {
        ...
        private void MostrarReporte()
        {
            ...
            rptViewerPdf.ProcessingMode = ProcessingMode.Remote;

            //Url del Servidor de Reporteria  
            rptViewerPdf.ServerReport.ReportServerUrl
                = new Uri(ObtenerUrlReportingService());

            //Path del Reporte a consultar                  
            rptViewerPdf.ServerReport.ReportPath = string.Format("{0}{1}",
            ...
            rptViewerPdf.ServerReport.ReportServerCredentials = credencial;
            ...
            if (parametros != null)
            {
                ...
                rptViewerPdf.ServerReport.SetParameters(parametrosFinal);
            }

            rptViewerPdf.ShowExportControls = true;
            rptViewerPdf.ShowPrintButton = false;

            //Configuracion General
            rptViewerPdf.ShowParameterPrompts = false;
            rptViewerPdf.ShowZoomControl = false;
            rptViewerPdf.ServerReport.Refresh();
        }
    }

    public class CustomReportCredentialsPreview : Microsoft.Reporting.WebForms.IReportServerCredentials
    {

        // local variable for network credential.
        private string _UserNamePdf;
        private string _PassWordPdf;
        private string _DomainNamePdf;
        public CustomReportCredentialsPreview(string userName, string password, string domainName)
        {
            _UserNamePdf = userName;
            _PassWordPdf = password;
            _DomainNamePdf = domainName;
        }
        ...
        public System.Net.ICredentials NetworkCredentials
        {
            get
            {
                ...
                return new System.Net.NetworkCredential(_UserNamePdf, _PassWordPdf, _DomainNamePdf);
            }
        }
