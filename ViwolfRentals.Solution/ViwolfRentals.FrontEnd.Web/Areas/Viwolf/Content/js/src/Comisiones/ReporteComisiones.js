var reporteComisiones = function () {
    var txtFechaInicio = $("#txtFechaInicio");
    var txtFechaFinal = $("#txtFechaFinal");
    var txtComisionistas = $("#txtComisionistas");
    var chkComisionista = $("#chkComisionista");
    var btnGenerarComisiones = $("#btnGenerarComisiones");
    var txtEstadoComisiones = $("#txtEstadoComisiones");
    var idsComisionistas = "";
    var dateIni = null;
    var dateFin = null;
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                $(msg.Data).each(function (serverData) {
                    ...
                    if (idsComisionistas == "")
                        idsComisionistas = this[configuracion.Id]
                    else
                        idsComisionistas = idsComisionistas + "," +  this[configuracion.Id]
    ...
    var Init = function () {
        ...
        txtFechaInicio.val("");
        txtFechaFinal.val("");
        chkComisionista.change(function () {
            document.getElementById('txtComisionistas').disabled = document.getElementById("chkComisionista").checked;
        });
        btnGenerarComisiones.click(fnGenerarReporte);
    ...
    var fnGenerarReporte = function (e) {
        ...
        try {
            ...
            var IdComisionista = comisionista.options[comisionista.selectedIndex].value;            

            var estados = document.getElementById("txtEstadoComisiones");
            var IdEstado = estados.options[estados.selectedIndex].value;



            var oUrl = 'VerReporteComisiones';
            var oData =
            {

                "FechaInicial": dateIni,
                "FechaFinal": dateFin,
                "IDClienteComisionista": IdComisionista == 0 ? idsComisionistas : IdComisionista.toString(),
                "ComisionPaga": IdEstado.toString()
